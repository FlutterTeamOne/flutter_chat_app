...
class DynamicRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ...
          : 'DynamicRequest',
      createEmptyInstance: create)
    ..aOM<CreateMessageRequest>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'createMessage',
        protoName: 'createMessage',
        subBuilder: CreateMessageRequest.create)
    ..aOM<UpdateMessageRequest>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'updateMessage',
        protoName: 'updateMessage',
        subBuilder: UpdateMessageRequest.create)
    ..aOM<DeleteMessageRequest>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'deleteMessage',
        protoName: 'deleteMessage',
        subBuilder: DeleteMessageRequest.create)
    ..aOM<ReadMessageRequest>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'readMessage',
        protoName: 'readMessage',
        subBuilder: ReadMessageRequest.create)
    ..e<MessageStateEnum>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'messageState',
        $pb.PbFieldType.OE,
        protoName: 'messageState',
        defaultOrMaker: MessageStateEnum.connecting,
        valueOf: MessageStateEnum.valueOf,
        enumValues: MessageStateEnum.values)
    ..hasRequiredFields = false;
  ...
  factory DynamicRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DynamicRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DynamicRequest copyWith(void Function(DynamicRequest) updates) =>
      super.copyWith((message) => updates(message as DynamicRequest))
          as DynamicRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DynamicRequest create() => DynamicRequest._();
  DynamicRequest createEmptyInstance() => create();
  static $pb.PbList<DynamicRequest> createRepeated() =>
      $pb.PbList<DynamicRequest>();
  @$core.pragma('dart2js:noInline')
  static DynamicRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DynamicRequest>(create);
  static DynamicRequest? _defaultInstance;

  @$pb.TagNumber(1)
  CreateMessageRequest get createMessage => $_getN(0);
  @$pb.TagNumber(1)
  set createMessage(CreateMessageRequest v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set updateMessage(UpdateMessageRequest v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set deleteMessage(DeleteMessageRequest v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set readMessage(ReadMessageRequest v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set messageState(MessageStateEnum v) {
    setField(5, v);
  }
...
class DynamicResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ...
          : 'DynamicResponse',
      createEmptyInstance: create)
    ..aOM<CreateMessageResponse>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'createMessage',
        protoName: 'createMessage',
        subBuilder: CreateMessageResponse.create)
    ..aOM<UpdateMessageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'updateMessage',
        protoName: 'updateMessage',
        subBuilder: UpdateMessageResponse.create)
    ..aOM<DeleteMessageResponse>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'deleteMessage',
        protoName: 'deleteMessage',
        subBuilder: DeleteMessageResponse.create)
    ..aOM<ReadMessageResponse>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'readMessage',
        protoName: 'readMessage',
        subBuilder: ReadMessageResponse.create)
    ..e<MessageStateEnum>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory DynamicResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DynamicResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DynamicResponse copyWith(void Function(DynamicResponse) updates) =>
      super.copyWith((message) => updates(message as DynamicResponse))
          as DynamicResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DynamicResponse create() => DynamicResponse._();
  DynamicResponse createEmptyInstance() => create();
  static $pb.PbList<DynamicResponse> createRepeated() =>
      $pb.PbList<DynamicResponse>();
  @$core.pragma('dart2js:noInline')
  static DynamicResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DynamicResponse>(create);
  static DynamicResponse? _defaultInstance;

  @$pb.TagNumber(1)
  CreateMessageResponse get createMessage => $_getN(0);
  @$pb.TagNumber(1)
  set createMessage(CreateMessageResponse v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set updateMessage(UpdateMessageResponse v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set deleteMessage(DeleteMessageResponse v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set readMessage(ReadMessageResponse v) {
    setField(4, v);
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'dateCreate',
        protoName: 'dateCreate')
    ..aOS(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'dateUpdate',
        protoName: 'dateUpdate')
    ..aOS(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'dateDelete',
        protoName: 'dateDelete')
    ..a<$core.int>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<ContentType>(
        ...
        defaultOrMaker: ContentType.isText,
...
class ReadMessageRequest extends $pb.GeneratedMessage {
  ...
  ReadMessageRequest copyWith(void Function(ReadMessageRequest) updates) =>
      super.copyWith((message) => updates(message as ReadMessageRequest))
          as ReadMessageRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadMessageResponse extends $pb.GeneratedMessage {
  ...
  factory ReadMessageResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ReadMessageResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ReadMessageResponse copyWith(void Function(ReadMessageResponse) updates) =>
      super.copyWith((message) => updates(message as ReadMessageResponse))
          as ReadMessageResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReadMessageResponse create() => ReadMessageResponse._();
  ReadMessageResponse createEmptyInstance() => create();
  static $pb.PbList<ReadMessageResponse> createRepeated() =>
      $pb.PbList<ReadMessageResponse>();
  @$core.pragma('dart2js:noInline')
...
class CreateMessageResponse extends $pb.GeneratedMessage {
  ...
  factory CreateMessageResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateMessageResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  CreateMessageResponse copyWith(
      ...
      super.copyWith((message) => updates(message as CreateMessageResponse))
          as CreateMessageResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateMessageResponse extends $pb.GeneratedMessage {
  ...
  factory UpdateMessageResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UpdateMessageResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  UpdateMessageResponse clone() =>
      UpdateMessageResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UpdateMessageResponse copyWith(
      ...
      super.copyWith((message) => updates(message as UpdateMessageResponse))
          as UpdateMessageResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UpdateMessageResponse create() => UpdateMessageResponse._();
  UpdateMessageResponse createEmptyInstance() => create();
  static $pb.PbList<UpdateMessageResponse> createRepeated() =>
      $pb.PbList<UpdateMessageResponse>();
  @$core.pragma('dart2js:noInline')
...
class DeleteMessageRequest extends $pb.GeneratedMessage {
  ...
  DeleteMessageRequest copyWith(void Function(DeleteMessageRequest) updates) =>
      super.copyWith((message) => updates(message as DeleteMessageRequest))
          as DeleteMessageRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteMessageResponse extends $pb.GeneratedMessage {
  ...
  factory DeleteMessageResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeleteMessageResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  DeleteMessageResponse copyWith(
      ...
      super.copyWith((message) => updates(message as DeleteMessageResponse))
          as DeleteMessageResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
