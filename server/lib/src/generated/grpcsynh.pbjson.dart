...
const SynhMainUser$json = const {
  ...
  '2': const [
    ...
    const {'1': 'dateSyns', '3': 3, '4': 1, '5': 9, '10': 'dateSyns'},
  ],
};

/// Descriptor for `SynhMainUser`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List synhMainUserDescriptor = $convert.base64Decode('CgxTeW5oTWFpblVzZXISDgoCaWQYASABKAVSAmlkEhAKA2tleRgCIAEoCVIDa2V5EhoKCGRhdGVTeW5zGAMgASgJUghkYXRlU3lucw==');
...
@$core.Deprecated('Use dataDBRequestDescriptor instead')
const DataDBRequest$json = const {
  '1': 'DataDBRequest',
  '2': const [
...
/// Descriptor for `DataDBRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List dataDBRequestDescriptor = $convert.base64Decode('Cg1EYXRhREJSZXF1ZXN0Eh8KBXVzZXJzGAEgAygLMgkuU3luaFVzZXJSBXVzZXJzEh8KBWNoYXRzGAIgAygLMgkuU3luaENoYXRSBWNoYXRzEigKCG1lc3NhZ2VzGAMgAygLMgwuU3luaE1lc3NhZ2VSCG1lc3NhZ2Vz');
