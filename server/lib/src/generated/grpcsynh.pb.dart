...
class SynhMainUser extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SynhMainUser', createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateSyns', protoName: 'dateSyns')
  ...
  @$pb.TagNumber(3)
  $core.String get dateSyns => $_getSZ(2);
  @$pb.TagNumber(3)
  set dateSyns($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasDateSyns() => $_has(2);
  @$pb.TagNumber(3)
  void clearDateSyns() => clearField(3);
}
...
class DataDBRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataDBRequest', createEmptyInstance: create)
  ...
  DataDBRequest._() : super();
  factory DataDBRequest({
  ...
  factory DataDBRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DataDBRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DataDBRequest clone() => DataDBRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataDBRequest copyWith(void Function(DataDBRequest) updates) => super.copyWith((message) => updates(message as DataDBRequest)) as DataDBRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DataDBRequest create() => DataDBRequest._();
  DataDBRequest createEmptyInstance() => create();
  static $pb.PbList<DataDBRequest> createRepeated() => $pb.PbList<DataDBRequest>();
  @$core.pragma('dart2js:noInline')
  static DataDBRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DataDBRequest>(create);
  static DataDBRequest? _defaultInstance;
